...
import com.glacialware.r15k.view.wireframes.playerDetail.PlayerDetailActivityWireframeImpl
import com.glacialware.r15k.viewmodel.views.playerDetail.PlayerDetailViewModel

/**
 * Created by Guille on 17/11/2017.
 */
class PlayerDetailActivityPresenterImpl(private val view: PlayerDetailActivity) : PlayerDetailActivityPresenter {

    private val wireframe: PlayerDetailActivityWireframe = PlayerDetailActivityWireframeImpl(view)
